      ...
      <div id="resume-template">
        ...
        <div className="resume-template main-paper">
          <div className="resume-template-body-1">
            {user.profilePicture ? (
              <img
                className="resume-template-profile-picture"
            ...
            <span className="resume-template-fullname">
              {user.fullName.toUpperCase()}
            </span>
            <br />
            <span className="resume-template-job-title">
            ...
            <div className="resume-template-personal-info">
              ...
              >
                <img
                  className="resume-template-personal-logo"
              ...
              >
                <img
                  ...
                  alt=""
                />
                <span style={{ cursor: "pointer" }}>{user.phoneNumber}</span>
                <br />
              </div>
              ...
              {user.nationality && (
                ...
                >
                  <img
                    className="resume-template-personal-logo"
                    src={process.env.PUBLIC_URL + "/images/nationality.png"}
                    alt=""
                  />
                  <span style={{ cursor: "pointer" }}>{user.nationality}</span>
                  <br />
                </div>
              )}
              ...
              >
                <img
                  ...
                  alt=""
                />
                <span style={{ cursor: "pointer" }}>{user.location}</span>
                <br />
              </div>
          ...
          <div className="resume-template-body-2">
            ...
            {resume.aboutMe.length > 0 && (
              <div>
                <h5 className="resume-template-content-title">
                  ABOUT
                  <img
                    className="resume-template-content-logo"
              ...
              <div>
                ...
                <div className="resume-template-content">
                  {resume.experience.map((experience, index) => (
                    <div>
                      <span key={index} href={experience}>
                        <strong>. </strong>
                        {experience}
                      </span>
                      <br />
            ...
            {resume.organization.length > 0 && (
              <div>
                <h5 className="resume-template-content-title">
                  ...
                  <img
                    className="resume-template-content-logo"
                    src={process.env.PUBLIC_URL + "/images/organization.png"}
                    alt=""
                  />
                </h5>
                <div className="resume-template-content">
                  {resume.organization.map((organization, index) => (
                    <div>
                      <span key={index} href={organization}>
                        <strong>. </strong>
                        {organization}
                      </span>
                      <br />
            ...
            {resume.course.length > 0 && (
              <div>
                <h5 className="resume-template-content-title">
                  ...
                  <img
                    className="resume-template-content-logo"
                    src={process.env.PUBLIC_URL + "/images/course.png"}
                    alt=""
                  />
                </h5>
                <div className="resume-template-content">
              ...
              <div>
                ...
                <div className="resume-template-content">
                  {resume.certificate.map((certificate, index) => (
                    <div>
                      <span key={index} href={certificate}>
                        <strong>. </strong>
                        {certificate}
                      </span>
                      <br />
